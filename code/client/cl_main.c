...
void CL_InitRenderer( void ) {
	...
	// load character sets
	cls.charSetShader = re.RegisterShader( "gfx/2d/font_main" ); // darks: gfx/2d/font_main, q3: gfx/2d/bigchars
...
void CL_Init( void ) {
	...
	// userinfo
	Cvar_Get ("name", "Talia", CVAR_USERINFO | CVAR_ARCHIVE );
	cl_rate = Cvar_Get ("rate", "25000", CVAR_USERINFO | CVAR_ARCHIVE );
	Cvar_Get ("snaps", "20", CVAR_USERINFO | CVAR_ARCHIVE );
	Cvar_Get ("model", "talia", CVAR_USERINFO | CVAR_ARCHIVE );
	Cvar_Get ("headmodel", "talia", CVAR_USERINFO | CVAR_ARCHIVE );
	Cvar_Get ("team_model", "talia", CVAR_USERINFO | CVAR_ARCHIVE );
	Cvar_Get ("team_headmodel", "talia", CVAR_USERINFO | CVAR_ARCHIVE );
	...
	Cvar_Get ("sex", "female", CVAR_USERINFO | CVAR_ARCHIVE );
